...
namespace Nomic
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Nomic.AutoSDKRetryOptions Retry { get; set; } = new global::Nomic.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Nomic.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Nomic.IAutoSDKHook>();
        ...
        public global::Nomic.AutoSDKClientOptions AddHook(
            global::Nomic.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Nomic.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Nomic.AutoSDKClientOptions UseAuthorizationProvider(
            global::Nomic.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Nomic.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Nomic.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Nomic.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Nomic.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Nomic.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Nomic.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Nomic.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Nomic.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Nomic.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Nomic.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Nomic.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Nomic.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Nomic.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Nomic.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Nomic.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Nomic.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Nomic.AutoSDKClientOptions clientOptions,
            global::Nomic.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Nomic.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Nomic.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Nomic.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Nomic.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Nomic.IAutoSDKHook, global::Nomic.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Nomic.AutoSDKHookContext context)
        {
