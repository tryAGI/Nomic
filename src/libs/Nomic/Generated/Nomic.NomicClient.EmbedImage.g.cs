...
namespace Nomic
{
    public partial class NomicClient
    {
        ...
        {
            var __response = await EmbedImageAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Nomic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Nomic.AutoSDKHttpResponse<global::Nomic.EmbeddingResponse>> EmbedImageAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Nomic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Nomic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "EmbedImageAsync",
                                pathTemplate: "\"/v1/embedding/image\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
